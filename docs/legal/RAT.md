...
| **Medidas de seguridad** | Aislamiento por espacio de trabajo en la autorización del servidor; RLS activa en todas las tablas como segunda barrera (espacios y tableros por membresía; tarjetas, columnas y categorías solo por organización), ON DELETE CASCADE en FK, uploads con magic-bytes validation (post B-CRIT-01 audit) |
